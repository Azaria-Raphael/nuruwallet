...
// ---------------------------------------------------------------------------
// _CategoryBudgetCard — owns its dialog so BuildContext is always fresh
// ---------------------------------------------------------------------------
...
class _CategoryBudgetCard extends ConsumerWidget {
  ...
  Future<void> _showSetLimitDialog(
    ...
    final controller = TextEditingController(
      text: category.monthlyLimit > 0
          ? category.monthlyLimit.toInt().toString()
          : '',
    );
    ...
    final result = await showDialog<double>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Set the maximum you want to spend on ${category.name} this month.',
                  ...
                  if (isOver)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            AppColors.budgetOver.withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: Text(
                        'Over',
